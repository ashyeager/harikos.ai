...
export default function HowItWorksPage() {
  return <MarketingShell><main className="public-page how-page">
    ...
    <PublicSection eyebrow="THE SYSTEM MOVING" title={<>One change propagates<br /><span>without losing history.</span></>} copy="This illustrative loop compresses the product lifecycle into a clear sequence." tone="blue"><ExampleLabel /><CinematicLoop /></PublicSection>
