...
export default function AboutPage() {
  return <MarketingShell><main className="public-page about-page">
    ...
    <PublicSection eyebrow="THE PRODUCT PRINCIPLE" title={<>Remember what happened.<br /><span>Verify what is true.</span></>} copy="That distinction is the center of HARIKOS. Memory preserves the path. Truth represents what current evidence supports. Context selects the relevant parts for the work in front of you." tone="accent"><div className="about-equation"><span>TRUTH</span><i>+</i><span>MEMORY</span><i>+</i><span>CONTEXT</span><i>+</i><span>AGENT BRIDGE</span><strong>PROJECT BRAIN</strong></div></PublicSection>
    <PublicSection eyebrow="CONTACT / HARIKOS" title={<>Talk directly to<br /><span>the company behind the product.</span></>} copy="Questions about HARIKOS, access, or the product direction go directly to the team."><div className="contact-identity"><span>CONTACT</span><h3>Zeus Yeager</h3><a href="mailto:zeusyeager469@gmail.com">zeusyeager469@gmail.com</a><a href="https://www.instagram.com/harikos.ai/" rel="noreferrer" target="_blank">Instagram @harikos.ai ↗</a></div></PublicSection>
    <section className="parent-company"><div><span>BUILT BY HARIKOS</span><h2>HARIKOS AI is an independent product with a simple mission: keep AI-built software understandable.</h2></div><a href="https://harikos.vercel.app/" rel="noreferrer" target="_blank">Visit HARIKOS <span>&rarr;</span></a><Link href="/security">Read the security model</Link></section>
