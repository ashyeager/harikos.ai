...
export const metadata: Metadata = { title: "Pricing", description: "Start HARIKOS free with one repository and one agent connection. Pro is $1 per month for up to five projects and agents." };
...
export default function PricingPage() {
  return <MarketingShell><main className="public-page pricing-page">
    ...
    <section className="plan-grid">
      ...
      <article className="plan-pro"><header><span>PRO</span><small>CURRENT LAUNCH HYPOTHESIS</small></header><div className="plan-price"><strong>$1</strong><span>/ month</span></div><p>More projects, agent connections, Memory capacity, Context Packs, and usable history.</p><SubscribeButton /><footer>SUBSCRIPTION STATE COMES FROM STRIPE</footer></article>
    </section>
    <section className="pricing-note"><span>FUTURE TIERS / COMING SOON</span><p>Enterprise and organization plans launching Q4 2026</p></section>
