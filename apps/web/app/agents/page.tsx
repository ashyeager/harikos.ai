...
export default function AgentsMarketingPage() {
  return <MarketingShell><main className="public-page agents-page">
    ...
    <PublicSection eyebrow="THE HANDOFF" title={<>One agent learns.<br /><span>The next agent benefits.</span></>} copy="HARIKOS sends relevant current facts and useful project history without transferring an entire private transcript." tone="accent"><ExampleLabel /><AgentHandoff /></PublicSection>
