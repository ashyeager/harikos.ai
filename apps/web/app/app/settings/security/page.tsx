...
export default function SecuritySettingsPage() {
  ...
  const checks = [["Supabase Auth", status.supabaseAuth, "Session and identity boundary"], ["PostgreSQL", status.postgres, "Private project persistence"], ["GitHub App", status.githubApp, "Read-only repository authorization"], ["Paddle Billing", status.paddle, "Subscription and webhook boundary"]] as const;
