...
export default async function MemoryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <AppShell snapshot={snapshot}>
      <PageHeader eyebrow="MEMORY" title="Keep the project’s history useful." copy="Decisions, failures, constraints, and outcomes persist separately from current Truth." />
