...
export default function ContextMarketingPage() { return <MarketingShell><main className="public-page context-page">
  ...
  <PublicSection eyebrow="CONTEXT COMPRESSION" title={<>A hundred project signals.<br /><span>One focused technical brief.</span></>} copy="Change the visual between the full signal field and the focused result. Irrelevant state dims; current facts and useful history remain." tone="blue"><div id="compression"><ExampleLabel /><ContextCompression /></div></PublicSection>
