    ...
    >
      ...
      <div className="flex items-start justify-between mb-4 relative z-10">
        <div className="flex items-center gap-2">
          <Database size={12} className="text-muted group-hover:text-cyan transition-colors" />
      ...
      <h3 className="text-base font-bold text-white mb-2 leading-snug relative z-10 group-hover:text-cyan transition-colors">
        {claim.value}
      </h3>
      ...
      <div className="mt-auto pt-4 border-t border-line relative z-10">
        ...
        <div className="flex justify-between items-center text-[9px] text-muted">
          ...
          <b className="font-mono text-cyan opacity-0 group-hover:opacity-100 transition-opacity -translate-x-2 group-hover:translate-x-0">
            Inspect &rarr;
          </b>
        </div>
      </div>
