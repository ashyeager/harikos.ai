import { candidateClaimSchema, projectSnapshotSchema, } from "./domain.js";
...
function evidence(path, excerpt, authority, commitSha = secondCommit, sourceType = "file") {
    return {
        sourceType,
        path,
...
function candidate(category, subject, value, claimEvidence, scope = null) {
...
export function createFlagshipDemoSnapshot() {
    const clerk = candidate("Authentication", "authentication", "Clerk", [
    ...
    const stateB = resolveTruth(stateA.truths, [
        candidate("Authentication", "authentication", "Supabase Auth", [
        ...
        candidate("Authentication", "authentication", "Clerk", [evidence("README.md", "Authentication: Clerk", 0.34, secondCommit, "documentation")], "application"),
