-- Historical baseline corresponding to the already-applied remote phase0_production_foundation migration.
-- Preserved locally so Supabase migration history remains coherent.
